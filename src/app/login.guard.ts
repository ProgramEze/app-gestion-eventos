...
export class LoginGuard implements CanActivate {
  ...
  canActivate(
    ...
    if (!this.loginService.isLoggedIn() || !requiredRole.includes(this.loginService.isRoleIn())) {
      this.router.navigate(['/']);  // Redirigir al inicio si no está logueado
      return false;
    }

    return true; // Permitir acceso si está logueado y tiene el rol adecuado
  }
}
